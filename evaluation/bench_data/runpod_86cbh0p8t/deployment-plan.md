...
- Budget guard: warn at one hour; terminate before two hours. MCP create-pod has no timed-termination field, so teardown is an active-session responsibility. Do not invent one.
