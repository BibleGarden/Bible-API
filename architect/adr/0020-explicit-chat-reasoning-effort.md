...
Gemini chat stages reject this variable, except the Gemini 2.5 Flash question
profile of [ADR 0024](0024-gemini-question-thinking-off.md), which maps `none`
to the Google-specific thinking budget. There is no shared reasoning variable or
